...
The CLI creates a GitHub issue in [hstm-labs/pawmate-ai-results](https://github.com/hstm-labs/pawmate-ai-results) with:
...
- Check: [github.com/hstm-labs/pawmate-ai-results](https://github.com/hstm-labs/pawmate-ai-results)
