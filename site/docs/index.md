...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/rsdickerson/pawmate-ai-challenge
  image:
    src: /logo.png
    alt: PawMate
...
Check out the [FAQ](/faq) or [view the spec on GitHub](https://github.com/rsdickerson/pawmate-ai-challenge).
