...
2. Configure DNS:
   ...
   - **Subdomain:** Add CNAME to `rsdickerson.github.io`
...
**Full documentation:** https://pawmate.ai (or https://rsdickerson.github.io/pawmate-site/)
...
```json
{
  ...
  "bugs": {
    "url": "https://github.com/rsdickerson/pawmate-ai-challenge/issues"
  }
}
```
