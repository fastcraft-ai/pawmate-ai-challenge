...
1. Change `name` in `package.json` (e.g., `@hstm-labs/pawmate-ai-challenge`)
...
- **GitHub repo:** https://github.com/hstm-labs/pawmate-ai-challenge
- **CLI README:** https://github.com/hstm-labs/pawmate-ai-challenge/tree/main/cli
